  ...
  return (
    <div className="card">
      ...
      <table className="table">
        <thead><tr><th>Data</th><th>Turniej</th><th>Gracze</th><th>Zwycięzca</th><th>Wynik</th></tr></thead>
        <tbody>
          {matches.map((m) => (
            <tr key={m.id} className="border-t border-gray-100 align-top">
              ...
              <td className="pr-4"><ul className="list-disc list-inside">{m.players.map(p => <li key={p}>{p}</li>)}</ul></td>
